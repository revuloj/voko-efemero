...
eo_def('vrt/eo_def_n.csv'). % eo-de/en/fr
db_celo('pdb/eo_zh_n.db').
csv_celo('vrt/eo_zh_n.csv').
...
zh_pr_vokal_super(V,D,VS) :-
    once((        
        member(D-V-VS,[
            1-a-'ā', 1-e-'ē', 1-i-'ī', 1-o-'ō', 1-u-'ū',1-ü-'ǖ',
            2-a-'á', 2-e-'é', 2-i-'í', 2-o-'ó', 2-u-'ú',2-ü-'ǘ',
